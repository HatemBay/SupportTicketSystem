    ...
    <div>
        ...
        <div class="d-sm-flex row">
            <h2 class="col-lg-6 col-7 h3 mb-0 text-gray-800 pl-5">
                Dashboard/ Knowledge Base/ Categories
            </h2>
...
export default {
    ...
    methods: {
        ...
        deleteCategory(id) {
            this.$dialog
                .confirm(
                    "You Will Also Delete All The Data Under This Category, Do You Want To Proceed?"
                )
                .then(dialog => {
                    axios
                        .delete("/tickets-system/public/api/categories/" + id)
                        .then(res => {
